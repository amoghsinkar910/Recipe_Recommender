...
def find_similar_words(embeddings, word1):
  nearest = sorted(embeddings.keys(), key= lambda word2: cosine_similarity(word2, word1))[:10]
  return nearest


word1 = input('Enter word 1: ')

sim = find_similar_words(embeddings, word1)

print("Similar words: ", sim)
